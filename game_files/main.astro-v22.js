            ...
            value: function () {
              ...
              this.shadowRoot.appendChild(Sa.content.cloneNode(!0)),
                ...
                (this.shadowRoot.querySelector("#puzzle-number").textContent =
                  "#".concat(this.gameApp.dayOffset - 536)),
                this.shadowRoot.addEventListener(
                  "game-switch-change",
                  function (e) {
                    e.stopPropagation();
...
"The nadir is the point on the celestial sphere directly below an observer. It is also the last Stardle word."
                ...
                if ((e.gameApp.gameStatus == "WIN" || e.gameApp.gameStatus == "FAIL") && funFacts.length > (e.gameApp.dayOffset - 447)) {
                  var funFact = funFacts[e.gameApp.dayOffset - 447];  
